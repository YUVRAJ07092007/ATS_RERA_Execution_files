# Rejoinder / Additional Submission on Behalf of the Existing Allottee
...
**In reply to:** ATS document `1-Response to the complaint to Vijayant Agarwal` (with enclosures)

## Subject

**Rejoinder to ATS response dated on or about May 2026 (`1-Response to the complaint to Vijayant Agarwal`) — for protection of the allottee's crystallised rights under the BBA and immediate execution/compliance of the HARERA order dated 18.04.2024.**
...
| **2** | Earlier sanctioned building/layout plans | Enclosed site plan; also on website | Website still lacks complete, downloadable, tower-wise and unit-wise plans. Partial upload is insufficient. |
...
| **11** | Fresh 30-day period from individual supply | Policy compliance; office visit offered | Rejected. Partial supply with evasive answers does not start valid objection period. |
...
All annexures are organized in folder **`01062026_Annexures/`** (see `00_ANNEXURE_INDEX.md`).

1. **Annexure 1** — HARERA order dated 18.04.2024 in Complaint No. 4463 of 2021.  
2. **Annexure 1** — Certified copy of HARERA order dated 18.04.2024, including Section 39 rectification proceedings dated 08.08.2024.  
3. **Annexure 7** — Agreement to Sell / BBA dated 25.10.2018, relevant pages (`Annexure_7_BBA_ATS_VIJYANT.pdf` in `01062026_Annexures/`, copied from `ATS RERA\\A\\2. BBA.pdf`).  
4. **Annexure 4** — Letter dated 23.10.2018 regarding pre-EMI/payment arrangement.  
5. **Annexure 2** — ATS reply and annexures, including revised-plan documents and comparative chart.  
6. **Annexure 3** — Previous representation/objection sent by the allottee.  
7. **Annexure 4** — Bank/pre-EMI/EMI payment records.  
8. **Annexure 5** — Execution complaint / execution documents already filed.  
